//
//  FileProvider.swift
//  DocumentProviderExtensionFileProvider
//
...
class FileProvider: NSFileProviderExtension {
    ...
    override func providePlaceholder(at url: URL, completionHandler: ((error: NSError?) -> Void)?) {
        ...
        let placeholderURL = NSFileProviderExtension.placeholderURL(for: try! self.documentStorageURL().appendingPathComponent(fileName))
    ...
    override func startProvidingItem(at url: URL, completionHandler: ((error: NSError?) -> Void)?) {
