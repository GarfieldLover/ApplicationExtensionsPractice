...
class ViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		*/
        AUAudioUnit.registerSubclass(AUv3InstrumentDemo.self, asComponentDescription: componentDescription, name: "Demo: Local InstrumentDemo", version: UInt32.max)
	...
	func embedPlugInView() {
        ...
        */
        ...
        let pluginURL = builtInPlugInsURL.URLByAppendingPathComponent("InstrumentDemoAppExtension.appex")
    ...
    */
	func connectParametersToControls() {
        ...
        attackParameter = parameterTree.valueForKey("attack") as? AUParameter
        releaseParameter = parameterTree.valueForKey("release") as? AUParameter
	...
	func updateAttack() {
        attackLabel.text = attackParameter.stringFromValue(nil)
	}

	func updateRelease() {
        releaseLabel.text = releaseParameter.stringFromValue(nil)
	}
