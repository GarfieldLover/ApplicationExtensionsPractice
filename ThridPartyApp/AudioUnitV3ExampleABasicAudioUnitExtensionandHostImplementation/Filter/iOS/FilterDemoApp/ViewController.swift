...
class ViewController: UIViewController {
	...
	override func viewDidLoad() {
		...
		*/
        AUAudioUnit.registerSubclass(AUv3FilterDemo.self, asComponentDescription: componentDescription, name:"Demo: Local FilterDemo", version: UInt32.max)
    ...
    */
    ...
    func logValueForNumber(number: Double)->Double {
        let value = log(number)/log(2);
        return value;
    }
    
    func frequencyValueForSliderLocation(location: Float)->Float {
