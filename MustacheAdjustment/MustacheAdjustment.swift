...
public class MustacheAdjustment {
    ...
    public func adjustmentData() -> PHAdjustmentData {
        let data: Data = NSKeyedArchiver.archivedData(withRootObject: self.mustachePositions)
    ...
    public func applyAdjustment(_ inputImage: UIImage) -> UIImage {
    ...
    public class func canHandleAdjustmentData(_ adjustmentData: PHAdjustmentData?) -> Bool {
